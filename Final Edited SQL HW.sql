...
-- from tables staff and variable payment staff_id
...
-- Using subqueries using the above tables, common coulumns (variables)
-- and join and where function:
...
-- Tables to be used film and category
-- common column to be joined on category_id, ,film_id
...
SELECT store.store_id, SUM(amount) AS 'Total Amount Brought IN'
 ...
 -- Solution: Columns to be displayed are store ID, city and country
